...
export default function HomePage() {
  ...
  async function handleConfirm() {
    ...
    createAppointment({ clientName:form.name, clientEmail:form.email, clientPhone:form.phone,
  ...
  return (
    <div dir={isAr?"rtl":"ltr"} style={{fontFamily:"Inter, sans-serif",overflowX:"hidden"}}>
      ...
      {/* ── NAV ─────────────────────────────────────────────────────────────── */}
      <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:300,height:68,
